...
from database_setup import Base, Catalog, ListItem, User
...
@app.route('/catalog/<int:catalog_id>/list/JSON')
def catalogListJSON(catalog_id):
...
@app.route('/catalog/<int:catalog_id>/list/<int:list_id>/JSON')
def listItemJSON(catalog_id, list_id):
...
def editCatalog(catalog_id):
    ...
    if editedCatalog.user_id != login_session['user_id']:
        ...
        to edit this catalog. Please create your own catalog in order to edit.
...
@app.route('/catalog/<int:catalog_id>/list/new/', methods=['GET', 'POST'])
...
@app.route('/catalog/<int:catalog_id>/list/<int:list_id>/edit',
           methods=['GET', 'POST'])
def editListItem(catalog_id, list_id):
    if 'username' not in login_session:
        return redirect('/login')
    ...
    if login_session['user_id'] != catalog.user_id:
        return '''<script>function myFunction() {alert('You are not authorized
        to edit list items to this catalog. Please create your own catalog in
    ...
    if request.method == 'POST':
        ...
        return render_template('editlistitem.html', catalog_id=catalog_id,
                               list_id=list_id, item=editedItem)


# Delete a list item
@app.route('/catalog/<int:catalog_id>/list/<int:list_id>/delete',
           methods=['GET', 'POST'])
def deleteListItem(catalog_id, list_id):
    if 'username' not in login_session:
        return redirect('/login')
    catalog = session.query(Catalog).filter_by(id=catalog_id).one()
    ...
    if login_session['user_id'] != catalog.user_id:
        ...
        delete list items to this catalog. Please create your own catalog in
